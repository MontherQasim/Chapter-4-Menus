...
void CMenusDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMenusDoc::InitializeSearchContent()
{
...
void CMenusDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
